<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="MySentReceived.aspx.cs" Inherits="BANKAPPPROJECT.MySentReceived" %>
...
<style>
    ...
    .pill-send    { background: rgba(212,176,106,0.12); color: var(--champagne); }
    .pill-receive { background: rgba(39,180,135,0.12);  color: var(--primary); }
    ...
    .null-ref { color: var(--muted); opacity: 0.35; }
                ...
                <asp:Repeater ID="rptResults" runat="server">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td>
                                <%# Eval("SentToAcctNo") != null && Eval("SentToAcctNo").ToString() != ""
                                    ? "<span class='acct-ref'>" + Eval("SentToAcctNo") + "</span>"
                                    : "<span class='null-ref'>—</span>" %>
                            </td>
                            <td>
                                <%# Eval("ReceivedFromAcctNo") != null && Eval("ReceivedFromAcctNo").ToString() != ""
                                    ? "<span class='acct-ref'>" + Eval("ReceivedFromAcctNo") + "</span>"
                                    : "<span class='null-ref'>—</span>" %>
                            </td>
                        </tr>
                    </ItemTemplate>
